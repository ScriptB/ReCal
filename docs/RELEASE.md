...
## 3. (Optional) Integrity Manifest

Generate an integrity manifest alongside the EXE:
- Build with `GenerateIntegrityManifest=true`, or
- Run `tools/release/GenerateIntegrityManifest.ps1 -OutputDir <output path>`
